...
{   
	...
	{ 
	  ...
	  $doc->addStyleSheet(JURI::root().'templates/vt_marketing/vtemtools/widgets/style.css');
      $doc->addScript(JURI::root().'templates/vt_marketing/vtemtools/widgets/jquery-1.7.2.min.js');
	  $doc->addScript(JURI::root().'templates/vt_marketing/vtemtools/widgets/script.js');
