...
function VTEMShowModule($name, $style, $modnumber, $logopos = '', $menupos = ''){
	...
	if($custommenu == 0){
	$vtemmainmenu = '<div id="vt_main_menu" class="vt_menufix clearfix"><div class="vt_bgmain_menuleft"></div>
						  <div class="vt_bgmain_menuright"></div><div id="vtem_menu" class="mlmenu plus '.$mootransition.'">' .$renderer->render( $module, $options ).'</div>';
